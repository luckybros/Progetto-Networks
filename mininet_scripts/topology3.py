...
class Environment(object):
    def __init__(self):
        ...
        self.h3 = self.net.addHost('h3', mac='00:00:00:00:00:03', ip='10.0.0.3')  # Nuovo host aggiunto
        ...
        self.net.addLink(self.h3, self.cpe1, bw=6, delay='0.0025ms')  # Collegamento per il terzo host
        self.net.addLink(self.cpe1, self.core1, bw=3, delay='25ms')
